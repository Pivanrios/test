...
function DishGallery({dishes}) {
  ...
  return (
    <div className='container flex flex-col items-center bg-slate-400 py-3 px-2 gap-1'>{//this is the section were we display our dishes 
      }<h3 className='text-2xl font-bold'>Dishes</h3>
      <div className='container flex flex-row gap-2 justify-between'>
